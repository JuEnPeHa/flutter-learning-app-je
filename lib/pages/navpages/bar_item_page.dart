...
import 'package:social_network_test/pages/thirdten.dart';
import 'package:social_network_test/pages/twelve.dart';
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            TextButton(
                onPressed: () {
                  Get.to(ComplexDrawerPage());
                },
                child: Text("11")),
            TextButton(
                onPressed: () {
                  Get.to(TextExampleWidget());
                },
                child: Text("12")),
            TextButton(
                onPressed: () {
                  Get.to(NeumorphExample());
                },
                child: Text("13")),
          ],
        ),
